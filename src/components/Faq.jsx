        ...
        <div className="my-14 md:flex justify-center items-center gap-5 p-3">
            <div className="md:w-1/2">
                <div className="mb-5 space-y-3">
                    <h3 className="text-2xl font-bold">About <span className="text-[#83B582]">Legal Vantage</span></h3>
                    <p>
                ...
                <div>
                    <h3 className="text-[#83B582] text-2xl font-bold underline mb-2">Subscribe</h3>
            ...
            <div className="md:w-1/2">
                <h3 className="text-2xl font-bold my-5">Frequently <span className="text-[#83B582]">Ask Questions</span></h3>
