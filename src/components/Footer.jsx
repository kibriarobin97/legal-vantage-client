...
const Footer = () => {
    return (
        <footer className="px-4 py-8 bg-gray-200">
            <div className="container max-w-7xl md:px-10 flex flex-wrap items-center justify-center mx-auto space-y-4 sm:justify-between my-5 sm:space-y-0">
                ...
                <div className="space-y-3">
                    ...
                    <div className="flex justify-start space-x-3">
                        <a data-aos-delay="800" rel="noopener noreferrer" href="#" title="Facebook" className="flex items-center p-1">
